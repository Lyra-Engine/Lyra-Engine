...
{
    std::size_t operator()(const lyra::rhi::GPUBufferDescriptor& d) const
    {
        std::size_t res = 0;
...
template <>
struct std::hash<lyra::rhi::GPUTextureDescriptor>
{
    std::size_t operator()(const lyra::rhi::GPUTextureDescriptor& d) const
    {
        std::size_t res = 0;

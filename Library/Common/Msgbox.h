...
namespace lyra
{
    inline void show_error(const String& title, const String& message)
    {
        boxer::show(message.c_str(), title.c_str(), boxer::Style::Error);
    }

    inline void show_warning(const String& title, const String& message)
    {
        boxer::show(message.c_str(), title.c_str(), boxer::Style::Warning);
    }

    inline void show_message(const String& title, const String& message)
    {
        boxer::show(message.c_str(), title.c_str(), boxer::Style::Info);
    }

    inline boxer::Selection show_confirm(const String& title, const String& message)
    {
